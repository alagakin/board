<template>
    <header class="bg-white">
        <div class="flex flex-row justify-between max-w-5xl mx-auto">
            ...
            <a href="#" class="p-3 mx-6 my-2 bg-blue-700 rounded-lg hover:bg-blue-900 text-white" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">Sign In</a>
        </div>
    </header>
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Sign in to Board</h3>
